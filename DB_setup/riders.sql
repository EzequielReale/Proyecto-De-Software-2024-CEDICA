CREATE TABLE riders (
    ...
    disability_id INTEGER REFERENCES disability_diagnoses(id) ON DELETE SET NULL,
    city_of_birth_id INTEGER NOT NULL REFERENCES localities(id) ON DELETE CASCADE,
    tutor_1_id INTEGER REFERENCES tutors(id) ON DELETE SET NULL,
    tutor_2_id INTEGER REFERENCES tutors(id) ON DELETE SET NULL
);
