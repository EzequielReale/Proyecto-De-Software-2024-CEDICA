...
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='team_index')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='team_new')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='team_destroy')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='team_update')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='team_show')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='reg_pagos_index')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='reg_pagos_new')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='reg_pagos_destroy')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='reg_pagos_update')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='reg_pagos_show')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='encuestre_index')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='encuestre_new')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='encuestre_destroy')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='encuestre_update')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='encuestre_show')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='jya_index')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='jya_new')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='jya_destroy')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='jya_update')),
((SELECT id FROM roles WHERE name='SystemAdmin'), (SELECT id FROM permissions WHERE name='jya_show'));
